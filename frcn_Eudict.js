...
class frcn_Eudict {
    ...
    async findEudict(url) {
        ...
        // frdic.com (igual que esdict.cn) cambió el id de este contenedor de
        // "ExpFCChild"/"ExpSPECChild" a "...child" en minúscula. Probamos
        // ambas variantes de mayúscula/minúscula para cada uno.
        let content = doc.querySelector('#ExpFCchild') || doc.querySelector('#ExpFCChild') ||
            doc.querySelector('#ExpSPECchild') || doc.querySelector('#ExpSPECChild') || '';
        if (!content) return [];
